...
sub index {
    ...
    return [qw|
        ...
        IMailServer InterScanMSS KDDI MailFoundry MailMarshalSMTP McAfee MessagingServer
        Notes Office365 OpenSMTPD Postfix Sendmail V5sendmail Verizon X1 X2 X3 X6 Yahoo Zoho mFILTER qmail
    |];
}
